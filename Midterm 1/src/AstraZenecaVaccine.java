...
public class AstraZenecaVaccine {
     ...
     * @throws IllegalArgumentException with or without error message if newRecipient is not
    ...
    public static int addRecipientToFront(String[] recipients, int size, String newRecipient,
                                          int age) {
        if (age > 55)
            throw new IllegalArgumentException("Prospective recipient is younger than 56");
     ...
     */
    public static int giveVaccineDoseToLast(String[] recipients, int size) {
        if (dosesCount < 1)
            throw new IllegalStateException();

        if (size == 0) {
            System.out.println("Error! No registered recipients in the list.");
            return size;
        }

        vaccinated.add(recipients[size - 1]);
    ...
    public static boolean testAddRecipient() {
        ...
        try {
            ...
            System.out.println(size = addRecipientToFront(recipients, size, "Bob", 25));
            System.out.println(size = addRecipientToFront(recipients, size, "George", 30));
            System.out.println(size = addRecipientToFront(recipients, size, "Emma", 75)); // IllegalArgumentException expected
            // to be thrown
            System.out
    ...
    public static boolean testAddRecipientNoRoom() {
        ...
        String[] recipients = newi String[] {"Michelle", "Sulong"};
        int size = 2;
        try {
